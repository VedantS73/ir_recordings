			...
			<div class="container-fliud">
				<div class="wrapper row">
					...
					<div class="details col-md-6">
                        ...
                        Terms & Conditions :
Thank you for considering Freya Vocal Sample Pack Vol I. This box outlines the agreed terms for usage of the sample pack unless otherwise stated.
...
The samples are not suitable for usage within content ID systems unless they are not recognisable.<br> i.e. any YouTube content ID strikes based around these samples invalidate their use and IR RECORDINGS retains full rights in these disputes.
IR RECORDINGS retains ownership of the original samples and IP and they are merely licenced to others on sale for use in your own compositions.
In addition to this, and samples that are free to download and royalty free are not suitable for major label placements [This only applies to the free sample packs].                        </p>
						<h4 class="price">Price: <span><strike>$10.00</strike> <span>$5.00</span></h4>
						
						<div class="action">
						</div>
                        <div> <a style=" width: 135px; background-color: #E19100; text-align: center; font-weight: 800; padding: 11px 0px; color: white; font-size: 12px; display: inline-block; text-decoration: none; " href='payment_gateway/dataFrom.htm' > Buy Now </a> </div>
					</div>
				</div>
			</div>
		</div>
